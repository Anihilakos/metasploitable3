...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "investigator" do |investigator|
    investigator.vm.box = "kalilinux/rolling"
    investigator.vm.hostname = "investigator"
    config.ssh.username = 'vagrant'
    config.ssh.password = 'vagrant'
    #ub1404.vm.network "pub", ip: '172.28.128.3'
    investigator.vm.network "public_network", ip: '192.168.1.220'
    #ub1404.vm.network :bridged
    investigator.vm.provider "virtualbox" do |v|
      v.name = "Kali-Lab"
      v.memory = 2048
    end
  end
  ...
  config.vm.define "ub1404" do |ub1404|
    ...
    #ub1404.vm.network "pub", ip: '172.28.128.3'
    ub1404.vm.network "public_network", ip: '192.168.1.223'
    #ub1404.vm.network :bridged
    ub1404.vm.provider "virtualbox" do |v|
      v.name = "Metasploitable-Ubuntu"
      v.memory = 2048
    end
  end
